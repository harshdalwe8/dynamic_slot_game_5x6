      ...
      <MainContent>
        ...
        <Content>
          ...
          <Section>
            ...
            <QuickActions>
              <QuickActionCard onClick={() => handleMenuClick({ id: 'themes', label: 'Theme Management', icon: '🎨', path: '/admin/themes' })}>
                <QuickActionIcon>🎨</QuickActionIcon>
                <QuickActionLabel>Manage Themes</QuickActionLabel>
                <QuickActionDesc>Create, edit, or delete game themes</QuickActionDesc>
              </QuickActionCard>

              <QuickActionCard onClick={() => handleMenuClick({ id: 'users', label: 'User Management', icon: '👥', path: '/admin/users' })}>
                <QuickActionIcon>👥</QuickActionIcon>
                <QuickActionLabel>View Users</QuickActionLabel>
                <QuickActionDesc>Manage user accounts and permissions</QuickActionDesc>
              </QuickActionCard>

              <QuickActionCard onClick={() => handleMenuClick({ id: 'reports', label: 'Reports', icon: '📈', path: '/admin/reports' })}>
                <QuickActionIcon>📈</QuickActionIcon>
